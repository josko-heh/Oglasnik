...
import hr.java.vjezbe.niti.DohvatiUslugeNit;
...
public class UslugaController {
	...
	public void initialize() {
		...
		DohvatiUslugeNit dohvati = new DohvatiUslugeNit(uslugeTable);
	...
	@FXML private void pretraziGumb() {
		...
		try {
			uslugeTable.setItems(FXCollections.observableArrayList(BazaPodataka.dohvatiUslugePremaKriterijima(naslov, opis, cijena)));
